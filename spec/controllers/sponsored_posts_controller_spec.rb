...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of SponsoredPost by 1" do
      expect{ sponsoredpost :create, params: { topic_id: my_topic.id, sponsoredpost: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price } } }.to change(Post,:count).by(1)
    end
